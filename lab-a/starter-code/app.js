...
function multiply(a, b) { //eslint-disable-line
    var myMult = a*b;
    var phrase = 'The product of 5 and 9 is 45.';

    return [myMult, phrase]
}
...
array where the first element is the sum of those three numbers, the second element is the product of those three numbers,
...
function sumArray(sumArr) {
 ...
 var phrase = sumArr[0] + ',' + sumArr[1] + ',' + sumArr[2] + ' was passed in as an array of numbers, and ' + sum2 + ' is their sum.';
...
function multiplyArray(multArr) { 
  ...
  var phrase = 'The numbers ' + testArray[0] + ','+ testArray[1] +',' + testArray[2] + ' have a product of ' + multi2 +'.';

  return [multi2, phrase];
}
...
function multiplyAnyArray(dynamicArray) {
  ...
  var phrase = 'The numbers ' + dynamicArray[0] + ',' + dynamicArray[1] + ',' + dynamicArray[2] + ',' + dynamicArray[3] + ',' + dynamicArray[4] + ' have a product of ' + result + '.';
